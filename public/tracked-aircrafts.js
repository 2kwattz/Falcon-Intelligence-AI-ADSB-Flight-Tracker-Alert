(() => {
  ...
  function showSatelliteMap(latitude, longitude, label) {
    ...
    const icon = window.L.divIcon({ className: "aircraft-map-marker", html: "<span>✈</span>", iconSize: [32, 32], iconAnchor: [16, 16] });
